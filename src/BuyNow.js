...
const BuyNow = () => {
    ...
    return (
        <div className="buy-now">
            {step === 1 && <ProductReview product={product} onNext={handleNext} />}
            {step === 2 && <ShippingOptions onNext={handleNext} onBack={handleBack} />}
            {step === 3 && <PaymentOptions onNext={handleNext} onBack={handleBack} />}
